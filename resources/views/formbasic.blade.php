...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>E-Reservasi - JakaTarub Rawa Bendungan</title>
...
<body>
				...
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						<span class="user-icon">
							<img src="{{asset('deskapp/vendors/images/tarub6.png')}}" alt="">
						</span>
	...
	<div class="left-side-bar">
		<div class="brand-logo">
			<a href="index.html">
				<img src="{{asset('deskapp/vendors/images/tarub9.png')}}" alt="" class="dark-logo">
				<img src="{{asset('deskapp/vendors/images/tarub9.png')}}" alt="" class="light-logo">
			</a>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
                ...
                <!-- <li><a href="index2.html">Dashboard style 2</a></li> -->
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-edit2"></span><span class="mtext">Formulir</span>
						</a>
						<ul class="submenu">
							<li><a href="form">Formulir Penyewaan</a></li>
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-library"></span><span class="mtext">Tabel Data Sewa</span>
						</a>
						<ul class="submenu">
							<!-- <li><a href="basic-table.html">Basic Tables</a></li> -->
							<li><a href="datasewa">Data Penyewaan</a></li>
						</ul>
					</li>
					<!-- <li>
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Formulir Penyewaan</li>
								</ol>
							</nav>
						</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Data Penyewaan</h4>
							<p class="mb-30">Data Penyewaan Properti Jaka Tarub</p>
						</div>
					...
					<form action="/simpansewa" method="post">
						@csrf
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Nama Penyewa</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" placeholder="isikan nama" name="nama_penyewa">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Id Penyewa</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control"  type="text" placeholder="isikan id penyewa" name="id_penyewa">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Nama Barang</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control"  type="text" placeholder="isikan nama barang" name="nama_barang">
							</div>
						</div>
						<div class="form-group row">
                  ...
                  <input
					...
					name="nomor_telepon">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control"  type="text" placeholder="isikan harga" name="harga">
							</div>
						</div>
						<!-- <div class="form-group row">
						...
						<div class="form-group row">
							<label for="example-datetime-local-input" class="col-sm-12 col-md-2 col-form-label">Tanggal Peminjaman</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" placeholder="pilih tanggal dan waktu" type="date" name="tanggal_peminjaman">
							</div>
						</div>
						<!-- <div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Tanggal Pengembalian</label>
							<div class="col-sm-12 col-md-10">
