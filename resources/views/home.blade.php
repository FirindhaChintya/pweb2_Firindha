    ...
    <div class="left-side-bar">
      <div class="brand-logo">
        <a href="index.html">
          ...
          <img
            src="{{asset('deskapp/vendors/images/tarub9.png')}}"
            alt=""
            class="light-logo"
          />
        </a>
          ...
          <ul id="accordion-menu">
            ...
            <li class="dropdown">
              <a href="javascript:;" class="dropdown-toggle">
                ...
                ><span class="mtext">Formulir</span>
              </a>
              <ul class="submenu">
                ...
                <li><a href="form-wizard.html">Formulir/a></li>
            ...
            <li class="dropdown">
              <a href="javascript:;" class="dropdown-toggle">
                ...
                ><span class="mtext">Tabel Data Sewa</span>
              </a>
              <ul class="submenu">
            ...
            <!-- <li>
              <a href="calendar.html" class="dropdown-toggle no-arrow">
                ...
                ><span class="mtext">Kalendar</span>
              </a>
            </li> -->
            <!-- <li class="dropdown">
              <a href="javascript:;" class="dropdown-toggle">
      ...
      <div class="pd-ltr-20">
        <div class="card-box pd-20 height-100-p mb-30">
          <div class="row align-items-center">
            <div class="col-md-4">
              <img src="{{asset('deskapp/vendors/images/tarub1.jpg')}}" alt="" />
            </div>
            <div class="col-md-8">
              ...
              <p class="font-18 max-width-600">
                MENYEWA gedung untuk menggelar hajatan tentunya membutuhkan
                biaya yang tidak sedikit. Biaya sewa gedung yang mahal membuat
                sejumlah orang enggan menggelar suatu hajatan di gedung.
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="card-box height-100-p widget-style1">
              <div class="d-flex flex-wrap align-items-center">
                ...
                <div class="widget-data">
                  ...
                  <div class="weight-600 font-14">Kualitas</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-box height-100-p widget-style1">
              <div class="d-flex flex-wrap align-items-center">
                ...
                <div class="widget-data">
                  ...
                  <div class="weight-600 font-14">Penawaran</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 mb-30">
            <div class="card-box height-100-p widget-style1">
              <div class="d-flex flex-wrap align-items-center">
                ...
                <div class="widget-data">
                  <div class="h4 mb-0">700ribu</div>
                  <div class="weight-600 font-14">Terjangkau</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="card-box mb-30">
          <h2 class="h4 pd-20">Barang Reservasi</h2>
          <table class="data-table table nowrap">
            ...
            <tbody>
              <tr>
                <td class="table-plus">
                  <img
                    src="{{asset('deskapp/vendors/images/tarub2.JPG')}}"
                    width="70"
                    height="70"
                    alt=""
                  />
              ...
              <tr>
                <td class="table-plus">
                  <img
                    src="{{asset('deskapp/vendors/images/tarub3.jpg')}}"
                    width="70"
                    height="70"
                    alt=""
                  />
                ...
                <td>
                  <h5 class="font-16">Kursi</h5>
                  by Jaka Tarub
                </td>
                <!-- <td>brown</td>
                <td>9UK</td> -->
                <td>Rp 10.000,00/per unit</td>
                <td>700</td>
                <td>
                  <div class="dropdown">
                    <a
              ...
              <tr>
                <td class="table-plus">
                  <img
                    src="{{asset('deskapp/vendors/images/tarub4.jpg')}}"
                    width="70"
                    height="70"
                    alt=""
                  />
                ...
                <td>
                  <h5 class="font-16">Sound System</h5>
                  by Jaka Tarub
                </td>
                <!-- <td>Orange</td>
                <td>M</td> -->
                <td>Rp 1.500.00,00/per24jam</td>
                <td>20</td>
                <td>
                  <div class="dropdown">
                    <a
              ...
              <tr>
                <td class="table-plus">
                  <img
                    src="{{asset('deskapp/vendors/images/tarub5.jpg')}}"
                    width="70"
                    height="70"
                    alt=""
                  />
                ...
                <td>
                  <h5 class="font-16">Alat Catering</h5>
                  by Jaka Tarub
                </td>
                <!-- <td>Gray</td>
                <td>L</td> -->
                <td>Rp.1.700.00,00/perhari</td>
                <td>100</td>
                <td>
                  <div class="dropdown">
                    <a
              ...
              <tr>
                <td class="table-plus">
                  <img
                    src="{{asset('deskapp/vendors/images/tarub7.jpg')}}"
                    width="70"
                    height="70"
                    alt=""
                  />
                ...
                <td>
                  <h5 class="font-16">Decor Tenda</h5>
                  by Jaka Tarub
                </td>
                <!-- <td>Blue</td>
                <td>M</td> -->
